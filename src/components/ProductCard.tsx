...
export const ProductCard: React.FC<ProductCardProps> = ({ name, image, description }) => {
  ...
  return (
    <div 
      className="group relative overflow-hidden rounded-2xl bg-white/10 backdrop-blur-lg border border-white/20 p-6 transition-all duration-500 hover:scale-105 hover:bg-white/15"
    ...
    >
      ...
      <div className="relative z-10">
        <div className="aspect-square overflow-hidden rounded-xl mb-4 bg-gradient-to-br from-white/10 to-white/5">
          <img 
            src={image} 
            alt={name}
